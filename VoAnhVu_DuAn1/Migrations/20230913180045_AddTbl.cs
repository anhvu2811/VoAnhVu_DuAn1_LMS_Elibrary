    ...
    public partial class AddTbl : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnnUserId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Announcement_User", x => x.AnnUserId);
                    table.ForeignKey(
                        name: "FK_Announcement_User_Announcement_AnnouncementId",
                        column: x => x.AnnouncementId,
                        principalTable: "Announcement",
                        principalColumn: "AnnouncementId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Announcement_User_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcement_User_AnnouncementId",
                table: "Announcement_User",
                column: "AnnouncementId");

            migrationBuilder.CreateIndex(
                name: "IX_Announcement_User_UserId",
                table: "Announcement_User",
                column: "UserId");
